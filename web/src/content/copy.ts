...
export const copy = {
  'pt-BR': {
    ...
    faq: [
      ...
      ['Posso controlar lâmpadas?', 'A interface local de iluminação está pronta para adaptadores padronizados. Integrações proprietárias de fabricante não fazem parte do núcleo.']
    ],
