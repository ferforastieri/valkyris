...
@Serializable data class ValkyrisEvent(val id:String,val cameraId:String="",val ruleId:String?=null,val source:String="camera",val subjectId:String="",val type:String,val confidence:Double,val occurredAt:String,val snapshotPath:String?=null,val clipPath:String?=null,val metadata:Map<String,JsonElement> = emptyMap(),val acknowledgedAt:String?=null)
...
@Serializable data class TrackedPerson(val id:String="",val name:String,val color:String="#5B5BD6",val deviceId:String="",val enabled:Boolean=true,val lastLatitude:Double?=null,val lastLongitude:Double?=null,val lastAccuracy:Double?=null,val lastLocatedAt:String?=null,val createdAt:String="",val updatedAt:String="")
...
@Serializable data class PersonLocation(val id:String="",val personId:String="",val latitude:Double,val longitude:Double,val accuracy:Double=0.0,val occurredAt:String="")
