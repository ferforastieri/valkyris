...
import com.ferforastieri.valkyris.core.database.MIGRATION_3_4
...
object AppModule {
    ...
    @Provides @Singleton fun database(@ApplicationContext context:Context)=Room.databaseBuilder(context,ValkyrisDatabase::class.java,"valkyris-cache.db").addMigrations(MIGRATION_3_4).fallbackToDestructiveMigration(false).build()
