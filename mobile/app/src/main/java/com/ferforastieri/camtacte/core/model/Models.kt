package com.ferforastieri.camtacte.core.model
...
@Serializable data class CamtacteEvent(val id:String,val cameraId:String,val ruleId:String?=null,val type:String,val confidence:Double,val occurredAt:String,val snapshotPath:String?=null,val clipPath:String?=null,val acknowledgedAt:String?=null)
