...
The installer validates that the MediaMTX configuration bind points to a file.
It stops with a clear message when an existing path is a directory instead of
changing an older installation automatically.
